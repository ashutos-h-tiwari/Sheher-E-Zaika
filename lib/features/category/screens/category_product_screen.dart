                ...
                if (scrollNotification is ScrollEndNotification) {
                  if((_tabController!.index == 1 && !catController.isRestaurant) || _tabController!.index == 0 && catController.isRestaurant) {
                    ...
                    if(catController.isSearching) {
                      ...
                      catController.searchData(catController.searchText, categoryId, catController.type);
                    } else {
                      if(_tabController!.index == 1) {
                        catController.getCategoryRestaurantListSilently(categoryId, catController.type);
                      } else {
                        catController.getCategoryProductListSilently(categoryId, catController.type);
                      }
                    }
                  }
                }
