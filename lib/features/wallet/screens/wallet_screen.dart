...
import 'package:sheherezaika/features/wallet/controllers/wallet_controller.dart';
import 'package:sheherezaika/features/wallet/widgets/bonus_banner_widget.dart';
import 'package:sheherezaika/features/wallet/widgets/wallet_card_widget.dart';
import 'package:sheherezaika/features/wallet/widgets/wallet_history_widget.dart';
import 'package:sheherezaika/features/wallet/widgets/web_bonus_banner_view_widget.dart';
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    // Text('kfdcgj kfdg klsdfg dszkgd k, ldfg dfjg kidgf kldfg lserf jslf l,ad'),
                          ...
                          return ResponsiveHelper.isDesktop(context) ? Padding(
                            ...
                            child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              Expanded (flex: 6, child: Column(children: [
                                if(Get.find<SplashController>().configModel!.addFundStatus!) const WebBonusBannerViewWidget(),
